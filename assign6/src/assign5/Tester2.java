...
//					d. Check to see if doubly linked list is empty.
					...
					System.out.println("3. Delete the data from end in the doubly linked list");
					System.out.println("4. Check how many elements are there in the doubly linked list");
					System.out.println("5. Check to see if doubly linked list is empty..");
					System.out.println("6. Insert the data at end in the doubly linked list");
					System.out.println("7. Delete the data from specific in the doubly linked list");
					...
					case 6:
						...
						linkedList.addAtSpecificPosition(element, position);
						break;
					case 7:
						System.out.println("Enter the position");
						position=sc.nextInt();
						System.out.println("Remove: " + linkedList.deleteAtSpecificPosition(position));
						break;
